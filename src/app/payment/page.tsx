  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] px-4 py-12">
      ...
      <div className="relative z-10 max-w-lg mx-auto">
        ...
        {/* Payment slip note */}
        <div className="bg-yellow-500/5 border border-yellow-500/15 rounded-xl px-5 py-4 mb-8">
          <div className="flex items-start gap-2.5">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-yellow-400/80 flex-shrink-0 mt-0.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              <path d="m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3Z" />
              <line x1="12" y1="9" x2="12" y2="13" />
              <line x1="12" y1="17" x2="12.01" y2="17" />
            </svg>
            <p className="text-yellow-400/80 text-xs leading-relaxed">
              After making a payment, please share the payment slip or screenshot with us via our WhatsApp or Telegram channel for quick confirmation.
            </p>
          </div>
        </div>
